...
def outputregion(regions, shape):       # output segment regions
    for key in regions:
        ...
        mrc_new = mrcfile.new('mrcfilestest/emd0414/emd0414_newalgo_nospon_normal_param23_6_10112019_rep1/{}'.format(fname), overwrite=True)
...
df.to_csv('mrcfilestest/emd0414/emd0414_newalgo_nospon_normal_param23_6_10112019_rep1/emd0414_newalgo_10112019_rep1.csv')
print("done")
