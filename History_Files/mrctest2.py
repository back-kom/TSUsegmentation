...
threshold = (2*mrc.data.mean()+mrc.data.max())/3
nx = mrc.header.nx
ny = mrc.header.ny
nz = mrc.header.nz
...
# emdr0 = mrcfile.new('mrcfilestest/emd4297r0.mrc', overwrite=True)
# emdr0.set_data(np.zeros(shape, dtype=np.float32))
# emdr0.voxel_size = mrc.voxel_size
# for v in regions[0]:
...
# emdr1.voxel_size = mrc.voxel_size
# for v in regions[1]:
...
# emdr2.voxel_size = mrc.voxel_size
# for v in regions[2]:
...
# emdr3.voxel_size = mrc.voxel_size
# for v in regions[3]:
...
# emdr4.voxel_size = mrc.voxel_size
# for v in regions[4]:
...
# emdr5.voxel_size = mrc.voxel_size
# for v in regions[5]:
...
# emdr6.voxel_size = mrc.voxel_size
# for v in regions[6]:
...
# emdr7.voxel_size = mrc.voxel_size
# for v in regions[7]:
...
# emdr8.voxel_size = mrc.voxel_size
# for v in regions[8]:
#     emdr8.data[v.x_coordinate, v.y_coordinate, v.z_coordinate] = v.density
#
# emdrx = mrcfile.new('mrcfiles/emd4297rx.mrc', overwrite=True)
# emdrx.set_data(np.zeros(shape, dtype=np.float32))
# emdrx.voxel_size = mrc.voxel_size
# for v in regionx:
#     emdrx.data[v.x_coordinate, v.y_coordinate, v.z_coordinate] = v.density
#
# emdr0.close()
# emdr1.close()
# emdr2.close()
